...
def main(argv):
    ...
    # spark server
    spark_url = 'spark://' + config.get("spark","dns") + ":7077"

    # postgresql server on both subnets
    postgres_url_1 = 'jdbc:postgresql://' + config.get("postgres","dns_1") + '/'\
                   + config.get("postgres","db") + '?ssl=require'
    postgres_url_2 = 'jdbc:postgresql://' + config.get("postgres","dns_2") + '/'\
                   + config.get("postgres","db") + '?ssl=require'                 
    ...
    #spark.driver.extraClassPath= "/usr/local/spark/lib/postgresql-42.2.4.jar"
    ...
    print("hehehe");df.show(n=2)
    print("hahaha")
    print(df.show(n=2))
    print(data_monthly_df.limit(10))
    print(data_monthly_df.show(n=10))
